export const ourSectors = [
  ...
  },
  {
    ...
    link: "/warehousing-and-logistics",
    color: "green-500",
  },
];
...
export const whyChooseUs = [
  {
    ...
    icon: { color: "violet-900", name: "groups" },
  ...
  },
  {
    ...
    text: "QS recruitment is GLAA & ALP accredited, with £10 million liability insurance. Plus no umbrella companies we save our clients and candidates money.",
  },
  {
    id: 4,
    title: "Our Own Transport Solutions",
    icon: { color: "violet-900", name: "local_taxi" },
    text: "We have a fleet of vehicles that are ready to transport our candidates to and from work.",
  },
