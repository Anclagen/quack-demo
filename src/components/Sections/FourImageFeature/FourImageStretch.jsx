          ...
          <div className="relative mt-10 lg:-mx-4 relative-20 lg:mt-0 lg:col-start-1">
            <div className="relative space-y-4">
              <div className="flex items-end justify-center space-x-4 lg:justify-start px-6 mb-6">
                <img className="hidden lg:block rounded-lg shadow-lg shadow-gray-500 md:w-56 xl:w-64 2xl:w-72" src={images[0]} />
                <img className=" rounded-lg shadow-lg shadow-gray-500 lg:w-64 xl:w-80 2xl:w-96" src={images[1]} alt="2" />
              </div>
              <div className="flex items-start justify-center ml-12 space-x-4 lg:justify-start ">
                <img className="hidden lg:block rounded-lg shadow-lg shadow-gray-500 md:w-40 xl:w-48 2xl:w-56" src={images[2]} alt="3" />
                <img className="hidden lg:block rounded-lg shadow-lg shadow-gray-500 md:w-60 xl:w-64 2xl:w-72" src={images[3]} alt="4" />
              </div>
            </div>
          </div>
          <div className="ml-auto lg:col-start-2 lg:max-w-2xl lg:ps-4">{children}</div>
        </div>
      </div>
    </div>
  );
