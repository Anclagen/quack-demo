...
const CTASection = ({ titleBlack, titlePurple, text, linkText, linkHref, image }) => {
  ...
  return (
    <div className={`flex overflow-hidden relative transition-all duration-2000 transform ${inView ? "" : "opacity-0 mt-20"}`} ref={ref}>
      <div className="text-start lg:w-1/2 text-center py-12 px-4 sm:px-6 lg:py-16 lg:px-8 z-20">
