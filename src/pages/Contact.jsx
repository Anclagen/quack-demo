...
const Contact = () => {
  return (
    <>
      <Banner title="Contact Us" slogan="Employer Or Job Seeker Were Here To Help" imgSrc="/src/assets/pexels-yan-krukau-8867434.jpg" imgAlt="Descriptive Image Alt Text" links={[]} />
